const {isCommand, ExtractDataFromMessage, DownloadImage} = require('./utils/index')
       ...
       const baileysMessage = messages[0]
        ...
        switch(command.toLowerCase()){
            ...
            case 'promover':
                ...
                await bot.sendMessage(messages[0].key.remoteJid, { text: 'Foi promovido a admin do grupo' }, { quoted: messages[0] })
                ...
                if(quotedMsg == "555195034449@s.whatsapp.net"){
                    ...
                    await bot.sendMessage(messages[0].key.remoteJid, { text: 'deixou de ser admin do grupo' }, { quoted: messages[0] })
                ...
                case 'ban':
                    ...
                    await bot.sendMessage(messages[0].key.remoteJid, { text: 'Foi promovido a vascaiano' }, { quoted: messages[0] })
                    ...
                    case 'link':
                        ...
                        const info = 'foi obtido o seguinte link do grupo https://chat.whatsapp.com/'.concat(code);
                        await bot.sendMessage(messages[0].key.remoteJid, { text: info }, { quoted: messages[0] })
                        break;
                    ...
                    case 'adm':
                        ...
                        case 'sticker':
                            ...
                            if(IsImage){
                                ...
                                exec (`ffmpeg -i ${inpuPath} -vf scale=512:512 ${outputPath} `, async (error) => {
                                    if(error){
                                        await bot.sendMessage(messages[0].key.remoteJid, { text: 'Ocorreram erros !' }, { quoted: messages[0] })
                                        return
                                    }

                                    await bot.sendMessage(messages[0].key.remoteJid, { sticker: {url :outputPath} })
                                ...
                                await bot.sendMessage(messages[0].key.remoteJid, { text: 'Não é uma imagem' }, { quoted: messages[0] })
                            }
                        ...
                        case 'remover':
                            ...
                            await bot.sendMessage(messages[0].key.remoteJid, { text: 'Banido com sucesso' }, { quoted: messages[0] })
